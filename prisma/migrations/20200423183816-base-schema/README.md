# Migration `20200423183816-base-schema`

This migration has been generated by Kervin at 4/23/2020, 6:38:16 PM.
...
CREATE TABLE "public"."ApplicationNote" (
    ...
    "createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "id" text  NOT NULL ,
    "type" "ApplicationNoteType" NOT NULL DEFAULT 'NOTE',
    "updatedAt" timestamp(3)  NOT NULL ,
    "user" text  NOT NULL ,
    PRIMARY KEY ("id")
) 
...
CREATE TABLE "public"."Job" (
    ...
    "maxCompensation" Decimal(65,30)  NOT NULL ,
    "minCompensation" Decimal(65,30)  NOT NULL ,
...
CREATE TABLE "public"."Location_boundary" (
...
ALTER TABLE "public"."Application" ADD FOREIGN KEY ("applicant")REFERENCES "public"."User"("id") ON DELETE CASCADE  ON UPDATE CASCADE
...
ALTER TABLE "public"."Job" ADD FOREIGN KEY ("branch")REFERENCES "public"."Branch"("id") ON DELETE SET NULL  ON UPDATE CASCADE

ALTER TABLE "public"."Job" ADD FOREIGN KEY ("cronTask")REFERENCES "public"."JobCronTask"("id") ON DELETE SET NULL  ON UPDATE CASCADE

ALTER TABLE "public"."Location_boundary" ADD FOREIGN KEY ("nodeId")REFERENCES "public"."Location"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."Permission" ADD FOREIGN KEY ("roleId")REFERENCES "public"."Role"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."Permission_actions" ADD FOREIGN KEY ("nodeId")REFERENCES "public"."Permission"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."Resume" ADD FOREIGN KEY ("fileId")REFERENCES "public"."File"("id") ON DELETE CASCADE  ON UPDATE CASCADE
...
+  position Int
+  value    Float
+  Location Location @relation(fields: [nodeId], references: [id])
+
+  @@id([nodeId, position])
+}
+
...
+  position   Int
+  value      String
+  Permission Permission @relation(fields: [nodeId], references: [id])
+
+  @@id([nodeId, position])
+}
+
