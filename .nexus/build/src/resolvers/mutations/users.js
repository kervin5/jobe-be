        ...
        resolve: async (parent, args, ctx) => {
            ...
            if (jobs.length) {
                ...
                const recruiters = await ctx.db.user.findMany({
                    where: {
                        branch: { id: (_a = user === null || user === void 0 ? void 0 : user.branch) === null || _a === void 0 ? void 0 : _a.id },
                        id: { not: user === null || user === void 0 ? void 0 : user.id },
                        role: { name: 'recruiter' },
                    },
                    take: 1,
                });
                if (recruiters.length) {
                    ...
                    const result = jobs.map((job) => ctx.db.job.update({
                        where: { id: job.id },
                    ...
                    const managers = await ctx.db.user.findMany({
                        where: {
                            branch: { id: (_b = user === null || user === void 0 ? void 0 : user.branch) === null || _b === void 0 ? void 0 : _b.id },
                            id: { not: user === null || user === void 0 ? void 0 : user.id },
                            role: { name: 'manager' },
                        },
                        take: 1,
                    ...
                    if (managers.length) {
                        ...
                        await ctx.db.job.updateMany({
                            where: { author: { id: user === null || user === void 0 ? void 0 : user.id } },
                            data: {
                                status: 'DELETED',
                            },
                        });
                        await ctx.db.application.updateMany({
                            where: { job: { author: { id: user === null || user === void 0 ? void 0 : user.id } } },
